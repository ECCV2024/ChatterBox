...
class DeformableTransformer(nn.Module):
    ...
    def __init__(self, d_model=256, nhead=8,
        ...
        self.compress_text=MLP(dim_text,d_model)
    ...
    def forward(self, srcs, masks, refpoint_embed, pos_embeds, tgt, attn_mask=None,sparse_embedding=None):
        ...
        # add_text:
        tgt=tgt+self.compress_text(sparse_embedding)
        tgt=self.merge_text_tgt(tgt)
