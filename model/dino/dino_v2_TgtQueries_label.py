...
class SetCriterion(nn.Module):
    ...
    def forward(self, outputs, targets, return_indices=False):
        ...
        num_boxes = torch.as_tensor([1], dtype=torch.float, device=device)  # fix the box number as 2
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='dino_v2_TgtQueries_label')
def build_dino(args):
