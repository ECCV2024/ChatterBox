...
from .segmentation import (DETRsegm, PostProcessPanoptic, PostProcessSegm,
                           dice_loss)
from .deformable_transformer_debug import build_deformable_transformer
...
class DINO(nn.Module):
    ...
    def forward_enc_dec(self, samples, features, poss, targets):
        ...
        for l, feat in enumerate(features):
            ...
            # print('for l, feat in enumerate(features)')
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='dino_debug')
def build_dino(args):
