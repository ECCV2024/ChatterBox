...
from .segmentation import (DETRsegm, PostProcessPanoptic, PostProcessSegm,
                           dice_loss)
from .deformable_transformer_sparse_query import build_deformable_transformer
...
class DINO(nn.Module):
    ...
    def forward_enc_dec(self, samples, features, poss, targets, sparse_query=None):
        ...
        hs, reference, hs_enc, ref_enc, init_box_proposal = self.transformer(srcs, masks, input_query_bbox, poss,
                                                                             input_query_label, attn_mask, sparse_query=sparse_query)
...
@MODULE_BUILD_FUNCS.registe_with_name(module_name='dino_v2_sparse_query')
def build_dino(args):
