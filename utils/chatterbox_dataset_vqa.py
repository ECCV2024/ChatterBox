...
class CBLCDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        with open(os.path.join('./', 'CB_LC.json')) as f:
    ...
    def __getitem__(self, idx):
        ...
        while True:
            ...
            # print('JackLogicVQADataset ----> ', conversations, len(conversations))
...
class CBMRGDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        while True:
            ...
            # print('JackVQADataset ----> ', conversations, len(conversations))
...
class LlavaDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        with open(os.path.join('./', "{}.json".format(vqa_data))) as f:
    ...
    def __getitem__(self, idx):
        ...
        # print('VQA image path  >> ', image_path)
        img = cv2.imread(image_path)
        ...
        # print('LlavaDataset ----> ', conversations, len(conversations))
