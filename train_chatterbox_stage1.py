...
from model.ChatterBox import ChatterBox
...
def parse_args(args):
    ...
    parser.add_argument("--dataset_dir", default="../VG/",
                        type=str)
...
def train(
    ...
    for global_step in range(args.steps_per_epoch):
        ...
        if global_step % 1 == 0:
            # print('step grounding  >>> ', global_step)
        ...
        if global_step % 30 == 0:
            save_dir = os.path.join('./output_stage1/', f'epoch_{epoch}')
            if args.local_rank == 0:
